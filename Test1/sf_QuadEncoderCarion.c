 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Oct 01 16:14:53 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sf_QuadEncoderCarion
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       overflow
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       underflow
...
extern void sf_QuadEncoderCarion_Update_wrapper(int16_T *pos,
			int16_T *overflow,
			int16_T *underflow,
			real_T *xD,
			const uint8_T *enc, const int_T p_width0,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    int16_T *overflow = (int16_T *) ssGetOutputPortRealSignal(S, 1);
    int16_T *underflow = (int16_T *) ssGetOutputPortRealSignal(S, 2);
    ...
    sf_QuadEncoderCarion_Outputs_wrapper(pos, overflow, underflow, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    sf_QuadEncoderCarion_Update_wrapper(pos, overflow, underflow, xD, enc, p_width0, pinA, p_width1, pinB, p_width2);
